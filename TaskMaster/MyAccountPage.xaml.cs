...
namespace TaskMaster
{
    ...
    public sealed partial class MyAccountPage : Page
    {
        ...
        {
            FullNameField.IsEnabled = !(FullNameField.IsEnabled);
            isEditing();
        ...
        {
            PhoneNumberField.IsEnabled = !(PhoneNumberField.IsEnabled);
            isEditing();
        }
        ...
        {
            SocialLinkField.IsEnabled = !(SocialLinkField.IsEnabled);
            isEditing();
        }
        private void changeAvatar_Click(object sender, RoutedEventArgs e)
        {
            chooseAvatar.IsOpen = !chooseAvatar.IsOpen;
        }
